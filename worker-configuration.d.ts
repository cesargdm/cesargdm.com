/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dcac4add85a284f2fe54bbb75c67d884)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STRAVA_ACCESS_TOKEN">> {}
}
